...
def profile_data_to_svg_file(profile_data_filename_):
	...
	p1 = subprocess.Popen([sys.executable, 'gprof2dot.py', '-n', '2', '-e', '2', '-f', 'pstats', profile_data_filename_], stdout=subprocess.PIPE)
	...
	#subprocess.check_call([sys.executable, 'add-panzoom-to-svg.py', svg_out_filename])
